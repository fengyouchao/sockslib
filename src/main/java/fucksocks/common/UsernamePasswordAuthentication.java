...
/**
 * The class <code>UsernamePasswordAuthencation</code> represents an
 * USERNAME/PASSWORD based authentication. This authentication is only 
 * supported by SOCKS5 protocol.
 * 
 * @author Youchao Feng

...
public class SessionFilterChain {
  ...
  private List<SessionFilter> sessionFilters;

  public SessionFilterChain() {
    sessionFilters = new ArrayList<SessionFilter>();
  }

  public void addFilter(SessionFilter sessionFilter) {
    this.sessionFilters.add(sessionFilter);
  }

  public void remoteFilter(SessionFilter sessionFilter) {

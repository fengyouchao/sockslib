...
/**
 * The class <code>SocksSocket</code> is proxy class that help developers
 * use {@link SocksProxy} as same as a java.net.Socket.<br>
 * For example:<br>
 * <pre>
 * 	SocksProxy proxy = new Socks5(new InetSocketAddress("127.0.0.1", 1080));
 *  //Setting proxy...
 * 	Socket socket = new SocksSocket(proxy, 
 * 			new InetSocketAddress("whois.internic.net",43));
...
public class SocksSocket extends Socket{
	 ...
	 */
	public SocksSocket(SocksProxy proxy, InetAddress address, int port) throws 

 ...
 * it's will be used by {@link SocksSocket} or {@link Socks5DatagramSocket}
 * 
 * @author Youchao Feng
...
public interface SocksProxy {
	 ...
	 * 
	 * <p>This method will ask SOCKS server to select a method from the methods 
	 * listed by client. If SOCKS server need authentication, it will do 
	 * authentication. If SOCKS server select 0xFF,It means that none of the 
	 * methods listed by the client are acceptable and this method should throw 
	 * {@link SocksException}.</p>
	 * 
	...
	/**
	 * This method will send a CONNECT command to SOCKS server and ask SOCKS
	 * server to connect remote server.
	 * 
	 ...
	 * @throws IOException		If any I/O error occurs.
	 */
	CommandReplyMesasge reqeustConnect(InetAddress address, int port) throws SocksException, IOException;
	 ...
	 * @throws IOException		If any I/O error occurs.
	 */
	CommandReplyMesasge requestUdpAssociat(String host, int port) 
			throws SocksException, IOException;
	 ...
	 * @throws IOException		If any I/O error occurs.
	 */
	CommandReplyMesasge requestUdpAssociat(InetAddress address, int port) 
			throws SocksException, IOException;

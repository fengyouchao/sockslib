...
/**
 * The class <code>RequestCmdReplyMesasge</code> represents the reply message 
 * from SOCKS server when client sends a command request.
 * 
 * @author Youchao Feng
...
public class CommandReplyMesasge implements SocksMessage{
	...
	/**
	 * Constructs CommandReplyMesasge instance by bytes that received
	 * from SOCKS server.
	 * 
	...
	public int getPort(){
		...
		return SocksUtil.bytesToPort(replyBytes[replyBytes.length-2], replyBytes[replyBytes.length-1]);
	}

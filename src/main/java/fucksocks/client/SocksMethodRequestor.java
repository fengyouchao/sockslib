 ...
 * send request message from SOCKS server and get a method that server
 * accepted.
 * 
 * @author Youchao Feng
...
public interface SocksMethodRequestor {
	 ...
	 * <p>This method will send list of methods to SOCKS server and receive the method
	 * that SOCKS server selected. </p>
	 * 
	 ...
	 */
	public SocksMethod doRequest(List<SocksMethod> acceptableMethods,
			Socket socket, int socksVersion) throws SocksException, IOException;
}
